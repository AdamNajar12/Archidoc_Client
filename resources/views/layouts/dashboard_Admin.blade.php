					...
					<div class="aside-menu flex-column-fluid">
						...
						<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
							...
							<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								...
								<div class="menu-item">
									<a class="menu-link {{ Request::is('Applications*') ? 'active' : '' }}" href="/Applications">
										<span class="menu-icon">
								...
								<div class="menu-item">
									<a class="menu-link {{ Request::is('type_interventions*') ? 'active' : '' }}" href="/type_interventions">
										<span class="menu-icon">
								...
								<div class="menu-item">
									<a class="menu-link {{ Request::is('statuts*') ? 'active' : '' }}" href="/statuts">
										<span class="menu-icon">
								...
								<div class="menu-item">
									<div class="menu-content pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">Statistiques</span>
									</div>
								</div>
								<div class="menu-item">
									<a class="menu-link {{ Request::is('tickets/charts*') ? 'active' : '' }}" href="/tickets/charts">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
										...
										<span class="menu-title">Voir les Stats</span>
									</a>
								</div>
								<div class="menu-item">
									<div class="menu-content pb-2">
										<span class="menu-section text-muted text-uppercase fs-8 ls-1">Chat</span>
									</div>
								</div>
								<div class="menu-item">
									<a class="menu-link {{ Request::is('/chatBack*') ? 'active' : '' }}" href="/chatBack">
										<span class="menu-icon">
											<!--bein::Svg Icon | path: icons/duotune/communication/com001.svg-->
											<span class="svg-icon svg-icon-2">
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
									...
									<div class="d-flex align-items-stretch flex-shrink-0">
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3">
											...
											<div class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px" id="kt_drawer_chat_toggle">
												...
												<a href="{{ route('users.chatBack') }}" class="btn btn-icon btn-active-light-primary position-relative w-30px h-30px w-md-40px h-md-40px" id="kt_drawer_chat_toggle">
    <!--begin::Svg Icon | path: icons/duotune/communication/com012.svg-->
    ...
    @endif
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px" data-kt-menu="true">
												...
												<div class="menu-item px-5">
													<a href="http://127.0.0.1:8000/profilBackCheck" class="menu-link px-5">My Profile</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
