...
<form class="form">
									...
									<div class="card">
										...
										<div class="card-header">
											<!--begin::Card header-->
											<div class="card-title fs-3 fw-bolder"> Detais type d intervention </div>
											<!--end::Card header-->
										</div>
										<!--end::Card header-->
										<!--begin::Card body-->
										<div class="card-body">
												...
												<div class="col-xl-9">
													...
													<div class="d-flex flex-column">
														<div class="d-flex justify-content-between w-100 fs-4 fw-bolder mb-3">
															<span>{{$type_intervention->libelle}}</span>
                                          ...
                                          <div class="row mb-8">
												...
												<div class="col-xl-9">
													...
													<div class="d-flex flex-column">
														<div class="d-flex justify-content-between w-100 fs-4 fw-bolder mb-3">
															<span>{{ $type_intervention->created_at}}  </span>
											...
											<div class="row mb-8">
												...
												<div class="col-xl-9">
													...
													<div class="d-flex flex-column">
														<div class="d-flex justify-content-between w-100 fs-4 fw-bolder mb-3">
															<span>{{ $type_intervention->updated_at }}  </span>
										...
										<div class="card-footer d-flex justify-content-end py-6">
											<a href="/type_interventions"class="btn btn-light me-3"id="kt_modal_add_customer_cancel">	Retour 
													</a>
										</div>
										<!--end::Card footer-->
									</div>
