                                                            ...
                                                            <tr>
																...
																<td>
																	<div class="d-flex justify-content-end flex-shrink-0">
																		...
																		<a href="#" onclick="event.preventDefault(); if(confirm('Êtes-vous sûr de vouloir supprimer cet article ?')) document.getElementById('delete-form-{{ $client->id }}').submit();"  class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
